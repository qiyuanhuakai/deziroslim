...
- **i18n** (#8): full bilingual support (zh-CN + en-US), 374 translation keys at 100% coverage; rust-i18n v4 with `t!()` macro; auto-detect system locale; all user-visible strings externalized
...
- 374 i18n keys across 2 locales
