...
use crate::ui::settings::hex_to_color32;
                            ...
                            ui.horizontal(|ui| {
                                ...
                                if ui
                                    .add_sized(
                                        [38.0, 22.0],
                                        egui::Button::new(
                                            egui::RichText::new(t!("settings.tags.add_button"))
                                                .size(10.5),
                                        )
                            ...
                            if app.saved_tags.is_empty() {
                                ...
                                for tag in &tags {
                                    ...
                                    let btn = egui::Button::new(
                                        egui::RichText::new(tag.as_str()).size(11.5).color(fg),
                                    )
                                    .fill(bg)
                                    .stroke(stroke)
                                    .rounding(egui::Rounding::same(6.0))
                                    .min_size(egui::vec2(ui.available_width().max(80.0), 22.0));
